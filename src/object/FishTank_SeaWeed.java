...
public class FishTank_SeaWeed extends Entity {
    ...
    public void getImage() {
        down1 = setup("object/seaWeed1", 28, 62);
        down2 = setup("object/seaWeed2", 28, 62);
        down3 = setup("object/seaWeed3", 28, 62);
        down4 = setup("object/seaWeed4", 28, 62);
        down5 = setup("object/seaWeed5", 28, 62);
    }
